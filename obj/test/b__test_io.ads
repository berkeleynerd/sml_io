...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_test_io" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#9819c830#;
   pragma Export (C, u00001, "test_ioB");
   ...
   u00113 : constant Version_32 := 16#752a67ed#;
   pragma Export (C, u00113, "system__concat_3B");
   u00114 : constant Version_32 := 16#fa0c42f6#;
   pragma Export (C, u00114, "system__concat_3S");
   u00115 : constant Version_32 := 16#0ddbd91f#;
   pragma Export (C, u00115, "system__memoryB");
   u00116 : constant Version_32 := 16#68e2c74e#;
